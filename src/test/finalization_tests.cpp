...
BOOST_AUTO_TEST_CASE(finalizationDelay)
{
    ...
    BOOST_CHECK_MESSAGE(
        GetFinalizedBlock() == nullptr, "No block finalized (tip at height " << chainActive.Tip()->height() << ")");
    ...
    CBlockIndex *blockToFinalize =
        chainActive.Tip()->GetAncestor(chainActive.Tip()->height() - DEFAULT_MAX_REORG_DEPTH);
    ...
    for (int i = 0; i < DEFAULT_MAX_REORG_DEPTH; i++)
    {
        ...
        BOOST_CHECK_MESSAGE(GetFinalizedBlock() == blockToFinalize,
            "Block finalized at height " << blockToFinalize->height() << " (tip at height "
    ...
    for (int i = 0; i < DEFAULT_MAX_REORG_DEPTH; i++)
    {
        ...
        BOOST_CHECK_MESSAGE(GetFinalizedBlock() == blockToFinalize,
            "Finalized block remains unchanged at height " << blockToFinalize->height() << " (tip at height "
                                                           << chainActive.Tip()->height() << ")");
    }
    ...
    blockToFinalize = chainActive.Tip()->GetAncestor(chainActive.Tip()->height() - DEFAULT_MAX_REORG_DEPTH);
