...
void CheckAncestors(MempoolData &expected_result, CTxMemPool &pool)
{
    ...
    if (iter->GetCountWithAncestors() != expected_result.nCountWithAncestors)
    {
        printf("%lu", iter->GetCountWithAncestors());
    }
    ...
    printf("TODO: tx structure changed so size changed to: %lu\n", iter->GetSizeWithAncestors());
...
BOOST_AUTO_TEST_CASE(MempoolUpdateChainStateTest)
{
    ...
    */
    ...
    {
        // Chain1:
        {tx1.GetId(), 1, 21, 1, 1000},
        {tx2.GetId(), 1, 21, 1, 2000},
        {tx3.GetId(), 1, 21, 1, 3000},
        {tx4.GetId(), 1, 21, 1, 4000},
        {tx5.GetId(), 2, 84, 2, 2000},
        {tx6.GetId(), 2, 84, 2, 4000},
        {tx7.GetId(), 2, 84, 2, 6000},
        {tx8.GetId(), 2, 84, 2, 8000},
        {tx9.GetId(), 5, 284, 5, 9000, true},
        {tx10.GetId(), 5, 273, 5, 21000, true},
        {tx11.GetId(), 12, 736, 12, 45000, true},
        {tx12.GetId(), 6, 369, 6, 10000, true},
        {tx13.GetId(), 13, 799, 13, 46000, true},
        {tx14.GetId(), 13, 799, 13, 46000, true},
        {tx15.GetId(), 7, 432, 7, 10500, true},
        {tx16.GetId(), 7, 432, 7, 10200, true},
        {tx17.GetId(), 7, 432, 7, 10300, true},
        {tx18.GetId(), 28, 1777, 28, 100000, true},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 1, 21, 1, 5000},

        // Chain2:
        {tx21.GetId(), 1, 19, 1, 100000},
        {tx22.GetId(), 2, 115, 2, 200000},
        {tx23.GetId(), 3, 184, 3, 220000},
        {tx24.GetId(), 4, 244, 4, 230000},
        {tx25.GetId(), 4, 244, 4, 230000},
        {tx26.GetId(), 9, 589, 9, 480000, true},
        {tx27.GetId(), 1, 19, 1, 101000},
        {tx28.GetId(), 2, 79, 2, 202000},
        {tx29.GetId(), 5, 304, 5, 603000, true},
        {tx30.GetId(), 6, 364, 6, 704000, true},
        {tx31.GetId(), 3, 175, 3, 220000},
        {tx32.GetId(), 3, 175, 3, 220000},
        {tx33.GetId(), 3, 175, 3, 220000},
        {tx34.GetId(), 4, 235, 4, 240000},
        {tx35.GetId(), 25, 1711, 25, 2044000, true},
        {tx36.GetId(), 26, 1771, 26, 2244000, true},
        {tx37.GetId(), 26, 1771, 26, 2125000, true},
        {tx38.GetId(), 53, 3643, 53, 7179000, true},

        // Chain3:
        {tx39.GetId(), 1, 20, 1, 1000},
        {tx40.GetId(), 1, 20, 1, 2000},
        {tx41.GetId(), 2, 91, 2, 10000},
        {tx42.GetId(), 5, 273, 5, 19000, true},
        {tx43.GetId(), 6, 333, 6, 31000, true},
        {tx44.GetId(), 1, 20, 1, 4000},
        {tx45.GetId(), 5, 271, 5, 35000, true},
        {tx46.GetId(), 3, 151, 3, 13000},
        {tx47.GetId(), 1, 19, 1, 10000},
        {tx48.GetId(), 7, 393, 7, 46000, true},
        {tx49.GetId(), 6, 331, 6, 49000, true}
    };
    /* clang-format on */
    ...
    */
    ...
    std::vector<MempoolData> txns_result =
    {
        ...
        {tx5.GetId(), 1, 63, 1, 1000},
        {tx6.GetId(), 1, 63, 1, 2000},
        {tx7.GetId(), 1, 63, 1, 3000},
        {tx8.GetId(), 1, 63, 1, 4000},
        {tx9.GetId(), 3, 242, 3, 6000},
        {tx10.GetId(), 3, 231, 3, 14000},
        {tx11.GetId(), 8, 652, 8, 35000},
        {tx12.GetId(), 4, 327, 4, 7000},
        {tx13.GetId(), 9, 715, 9, 36000},
        {tx14.GetId(), 9, 715, 9, 36000},
        {tx15.GetId(), 5, 390, 5, 7500},
        {tx16.GetId(), 5, 390, 5, 7200},
        {tx17.GetId(), 5, 390, 5, 7300},
        {tx18.GetId(), 12, 957, 12, 45000},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 1, 21, 1, 5000},
        ...
        {tx22.GetId(), 1, 96, 1, 100000},
        {tx23.GetId(), 2, 165, 2, 120000},
        {tx24.GetId(), 3, 225, 3, 130000},
        {tx25.GetId(), 3, 225, 3, 130000},
        {tx26.GetId(), 5, 386, 5, 160000},
        {tx27.GetId(), 1, 19, 1, 101000},
        {tx28.GetId(), 2, 79, 2, 202000},
        {tx29.GetId(), 4, 285, 4, 503000},
        {tx30.GetId(), 5, 345, 5, 604000},
        {tx31.GetId(), 2, 156, 2, 120000},
        {tx32.GetId(), 2, 156, 2, 120000},
        {tx33.GetId(), 2, 156, 2, 120000},
        {tx34.GetId(), 3, 216, 3, 140000},
        {tx35.GetId(), 13, 1048, 13, 924000},
        {tx36.GetId(), 14, 1108, 14, 1124000},
        {tx37.GetId(), 14, 1108, 14, 1005000},
        {tx38.GetId(), 16, 1269, 16, 4015000},

        // Chain3:
        {tx39.GetId(), 0, 0, 0, 0},
        {tx40.GetId(), 1, 20, 1, 2000},
        {tx41.GetId(), 1, 71, 1, 6000},
        {tx42.GetId(), 3, 233, 3, 14000},
        {tx43.GetId(), 4, 293, 4, 26000},
        {tx44.GetId(), 0, 0, 0, 0},
        {tx45.GetId(), 3, 232, 3, 21000},
        {tx46.GetId(), 2, 131, 2, 9000},
        {tx47.GetId(), 0, 0, 0, 0},
        {tx48.GetId(), 5, 353, 5, 41000},
        {tx49.GetId(), 4, 292, 4, 35000}
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result2 =
    {
        ...
        {tx40.GetId(), 0, 0, 0, 0},
        {tx41.GetId(), 0, 0, 0, 0},
        {tx42.GetId(), 1, 142, 1, 6000},
        {tx43.GetId(), 2, 202, 2, 18000},
        {tx44.GetId(), 0, 0, 0, 0},
        {tx45.GetId(), 2, 161, 2, 15000},
        {tx46.GetId(), 1, 60, 1, 3000},
        {tx47.GetId(), 0, 0, 0, 0},
        {tx48.GetId(), 3, 262, 3, 33000},
        {tx49.GetId(), 3, 221, 3, 29000}
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result3 =
    {
        ...
        {tx8.GetId(), 1,63, 1, 4000},
        {tx9.GetId(), 1,116 , 1, 3000},
        {tx10.GetId(), 2, 168, 2, 11000},
        {tx11.GetId(), 5, 463, 5, 29000},
        {tx12.GetId(), 2, 201, 2, 4000},
        {tx13.GetId(), 6, 526, 6, 30000},
        {tx14.GetId(), 6, 526, 6, 30000},
        {tx15.GetId(), 3, 264, 3, 4500},
        {tx16.GetId(), 3, 264, 3, 4200},
        {tx17.GetId(), 3, 264, 3, 4300},
        {tx18.GetId(), 9, 768, 9, 39000},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 1, 21, 1, 5000},
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result4 =
    {
        ...
        {tx11.GetId(), 2, 179, 2, 15000},
        {tx12.GetId(), 1, 85, 1, 1000},
        {tx13.GetId(), 3, 242, 3, 16000},
        {tx14.GetId(), 3, 242, 3, 16000},
        {tx15.GetId(), 2, 148, 2, 1500},
        {tx16.GetId(), 2, 148, 2, 1200},
        {tx17.GetId(), 2, 148, 2, 1300},
        {tx18.GetId(), 6, 484, 6, 25000},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 1, 21, 1, 5000},
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result5 =
    {
        ...
        {tx11.GetId(), 0, 0, 0, 0},
        {tx12.GetId(), 1, 85, 1, 1000},
        {tx13.GetId(), 1, 63, 1, 1000},
        {tx14.GetId(), 0, 0, 0, 0},
        {tx15.GetId(), 2, 148, 2, 1500},
        {tx16.GetId(), 2, 148, 2, 1200},
        {tx17.GetId(), 2, 148, 2, 1300},
        {tx18.GetId(), 3, 242, 3, 9000},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 0, 0, 0, 0}
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result6 =
    {
        ...
        {tx14.GetId(), 0, 0, 0, 0},
        {tx15.GetId(), 0, 0, 0, 0},
        {tx16.GetId(), 1, 63, 1, 200},
        {tx17.GetId(), 1, 63, 1, 300},
        {tx18.GetId(), 2, 179, 2, 8000},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 0, 0, 0, 0}
    };
    /* clang-format on */
    ...
    */
    ...
    std::vector<MempoolData> txns_result7 =
    {
        ...
        {tx24.GetId(), 1, 60, 1, 10000},
        {tx25.GetId(), 1, 60, 1, 10000},
        {tx26.GetId(), 3, 221, 3, 40000},
        {tx27.GetId(), 1, 19, 1, 101000},
        {tx28.GetId(), 2, 79, 2, 202000},
        {tx29.GetId(), 3, 189, 3, 403000},
        {tx30.GetId(), 4, 249, 4, 504000},
        {tx31.GetId(), 1, 60, 1, 20000},
        {tx32.GetId(), 1, 60, 1, 20000},
        {tx33.GetId(), 1, 60, 1, 20000},
        {tx34.GetId(), 2, 120, 2, 40000},
        {tx35.GetId(), 11, 883, 11, 804000},
        {tx36.GetId(), 12, 943, 12, 1004000},
        {tx37.GetId(), 12, 943, 12, 885000},
        {tx38.GetId(), 14, 1104, 14, 3895000},
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result8 =
    {
        ...
        {tx33.GetId(), 0, 0, 0, 0},
        {tx34.GetId(), 0, 0, 0, 0},
        {tx35.GetId(), 8, 703, 8, 744000},
        {tx36.GetId(), 9, 763, 9, 944000},
        {tx37.GetId(), 9, 763, 9, 825000},
        {tx38.GetId(), 11, 924, 11, 3835000},
    };
    /* clang-format on */
    ...
    std::vector<MempoolData> txns_result9 =
    {
        ...
        {tx24.GetId(), 0, 0, 0, 0},
        {tx25.GetId(), 0, 0, 0, 0},
        {tx26.GetId(), 1, 101, 1, 20000},
        {tx27.GetId(), 0, 0, 0, 0},
        {tx28.GetId(), 0, 0, 0, 0},
        {tx29.GetId(), 1, 110, 1, 201000},
        {tx30.GetId(), 2, 170, 2, 302000},
        {tx31.GetId(), 0, 0, 0, 0},
        {tx32.GetId(), 1, 60, 1, 20000},
        {tx33.GetId(), 0, 0, 0, 0},
        {tx34.GetId(), 0, 0, 0, 0},
        {tx35.GetId(), 4, 504, 4, 522000},
        {tx36.GetId(), 5, 564, 5, 722000},
        {tx37.GetId(), 5, 564, 5, 603000},
        {tx38.GetId(), 7, 725, 7, 3613000},
    };
    pool.removeForBlock(vtx, 1, dummy, false);
    BOOST_CHECK_EQUAL(pool.size(), 18);
    ...
    std::vector<MempoolData> txns_result10 =
    {
        ...
        {tx28.GetId(), 0, 0, 0, 0},
        {tx29.GetId(), 0, 0, 0, 0},
        {tx30.GetId(), 1, 60, 1, 101000},
        {tx31.GetId(), 0, 0, 0, 0},
        {tx32.GetId(), 0, 0, 0, 0},
        {tx33.GetId(), 0, 0, 0, 0},
        {tx34.GetId(), 0, 0, 0, 0},
        {tx35.GetId(), 0, 0, 0, 0},
        {tx36.GetId(), 1, 60, 1, 200000},
        {tx37.GetId(), 1, 60, 1, 81000},
        {tx38.GetId(), 3, 221, 3, 3091000},
    };
    /* clang-format on */
    ...
    */
    ...
    std::vector<MempoolData> txns_fully_updated =
    {
        ...
        {tx7.GetId(), 2, 84, 2, 6000},
        {tx8.GetId(), 2, 84, 2, 8000},
        {tx9.GetId(), 5, 284, 5, 9000},
        {tx10.GetId(), 5, 273, 5, 21000},
        {tx11.GetId(), 12, 736, 12, 45000},
        {tx12.GetId(), 6, 369, 6, 10000},
        {tx13.GetId(), 13, 799, 13, 46000},
        {tx14.GetId(), 13, 799, 13, 46000},
        {tx15.GetId(), 7, 432, 7, 10500},
        {tx16.GetId(), 7, 432, 7, 10200},
        {tx17.GetId(), 7, 432, 7, 10300},
        {tx18.GetId(), 16, 1041, 16, 55000},
        {tx19.GetId(), 1, 21, 1, 6000},
        {tx20.GetId(), 1, 21, 1, 5000},
        ...
        {tx24.GetId(), 4, 244, 4, 230000},
        {tx25.GetId(), 4, 244, 4, 230000},
        {tx26.GetId(), 6, 405, 6, 260000},
        {tx27.GetId(), 1, 19, 1, 101000},
        {tx28.GetId(), 2, 79, 2, 202000},
        {tx29.GetId(), 5, 304, 5, 603000},
        {tx30.GetId(), 6, 364, 6, 704000},
        {tx31.GetId(), 3, 175, 3, 220000},
        {tx32.GetId(), 3, 175, 3, 220000},
        {tx33.GetId(), 3, 175, 3, 220000},
        {tx34.GetId(), 4, 235, 4, 240000},
        {tx35.GetId(), 14, 1067, 14, 1024000},
        {tx36.GetId(), 15, 1127, 15, 1224000},
        {tx37.GetId(), 15, 1127, 15, 1105000},
        {tx38.GetId(), 17, 1288, 17, 4115000},

        // Chain3:
        {tx39.GetId(), 1, 20, 1, 1000},
        {tx40.GetId(), 1, 20, 1, 2000},
        {tx41.GetId(), 2, 91, 2, 10000},
        {tx42.GetId(), 5, 273, 5, 19000},
        {tx43.GetId(), 6, 333, 6, 31000},
        {tx44.GetId(), 1, 20, 1, 4000},
        {tx45.GetId(), 5, 271, 5, 35000},
        {tx46.GetId(), 3, 151, 3, 13000},
        {tx47.GetId(), 1, 19, 1, 10000},
        {tx48.GetId(), 7, 393, 7, 46000},
        {tx49.GetId(), 6, 331, 6, 49000}
    };
    /* clang-format on */
