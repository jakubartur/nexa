...
BOOST_AUTO_TEST_CASE(pushtxstate)
{
    ...
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 12345678, simpleConstraint));

    coins.push_back(CTxOut(CTxOut::LEGACY, 23456789, simpleConstraint));
    ...
    testScript(s, &tx, coins);
    coins.push_back(CTxOut(CTxOut::LEGACY, 34567890, simpleConstraint));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 34567890));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 45678901, simpleConstraint));
...
CScript tmplop1(const CGroupTokenID &group, CAmount amt)
{
    ...
    CScript constraint = CScript() << group.bytes() << SerializeAmount(amt) << OP_GROUP << hash256(tmpl) << OP_TEMPLATE;
    return constraint;
}
...
BOOST_AUTO_TEST_CASE(covenantedAndSubgroupPushtxstate)
{
    ...
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, tmplop1(grp1, 100)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, tmplop1op1(grp1, 200)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    // Pull in a subgroup and try to use it
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(subgrp, 200)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));

    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 10, simpleConstraint));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, tmplop1(grp1, 300)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(subgrp, 200)));
...
BOOST_AUTO_TEST_CASE(groupauthoritypushtxstate)
{
    ...
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(grp1, auth1)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(grp2, auth2)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(grp2, 600)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    coins.push_back(CTxOut(CTxOut::LEGACY, 10000, gp2op1(fgrp1, 0)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10000));
    coins.push_back(CTxOut(CTxOut::LEGACY, 2345, gp2op1(fgrp1, 0)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 2345));

    // Create a tx involving 2 groups with 3 inputs and 4 outputs
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 9, simpleConstraint));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp1, 1234)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp1, 1)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp2, 2)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp2, 3)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 12345, gp2op1(fgrp1, 0)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp2, auth2))); // Output a child authority
...
BOOST_AUTO_TEST_CASE(grouppushtxstate)
{
    ...
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp1, 7)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp2, 1)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp2, 2)));
    tx.vout.push_back(CTxOut(CTxOut::LEGACY, 1, gp2op1(grp2, 3)));

    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(grp1, 3)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(grp1, 4)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
    coins.push_back(CTxOut(CTxOut::LEGACY, 10, gp2op1(grp2, 6)));
    tx.vin.push_back(CTxIn(COutPoint(InsecureRand256()), 10));
